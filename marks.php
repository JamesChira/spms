		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="panel panel-success">
					<div class="panel-heading" style="text-align: center"><a href="student_potal.php" role="button" class="btn btn-success" style="float: left;width: 100px">&lt;&lt; Back</a> <h2>Student <?php echo $names."'s"; ?> Details</h2></div>
